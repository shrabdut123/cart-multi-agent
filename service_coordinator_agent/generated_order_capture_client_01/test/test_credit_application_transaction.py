...
class TestCreditApplicationTransaction(unittest.TestCase):
    """CreditApplicationTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditApplicationTransaction:
        """Test CreditApplicationTransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditApplicationTransaction`
        """
        model = CreditApplicationTransaction()
        if include_optional:
            return CreditApplicationTransaction(
                amount = 45.67,
                currency = 'SEK',
                status = 'CAPTURED ',
                iopg_id = 'EU123456789',
    ...
    def testCreditApplicationTransaction(self):
        """Test CreditApplicationTransaction"""
