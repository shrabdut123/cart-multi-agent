...
class TestDeltaPriceDto(unittest.TestCase):
    """DeltaPriceDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeltaPriceDto:
        """Test DeltaPriceDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeltaPriceDto`
        """
        model = DeltaPriceDto()
        if include_optional:
