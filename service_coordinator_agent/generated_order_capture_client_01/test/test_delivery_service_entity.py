...
class TestDeliveryServiceEntity(unittest.TestCase):
    """DeliveryServiceEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryServiceEntity:
        """Test DeliveryServiceEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryServiceEntity`
        """
        model = DeliveryServiceEntity()
        if include_optional:
    ...
    def testDeliveryServiceEntity(self):
        """Test DeliveryServiceEntity"""
