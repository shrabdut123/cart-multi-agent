...
class TestPaymentBrand(unittest.TestCase):
    """PaymentBrand unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentBrand:
        """Test PaymentBrand
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentBrand`
        """
        model = PaymentBrand()
        if include_optional:
            return PaymentBrand(
