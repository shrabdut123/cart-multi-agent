...
class TestOrderCaptureStateDto(unittest.TestCase):
    """OrderCaptureStateDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrderCaptureStateDto:
        """Test OrderCaptureStateDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrderCaptureStateDto`
        """
        model = OrderCaptureStateDto()
        if include_optional:
            return OrderCaptureStateDto(
                ...
                service_price = order_capture_client.models.price.Price(
                    ...
                    total_order_savings = 1.337, 
                    additional_savings_as_family = 1.337, ),
                goods_total = order_capture_client.models.price.Price(
                    type = 'TOTAL_PRICE', 
                    incl_tax = 1.337, 
                    excl_tax = 1.337, 
                    tax = 1.337, 
    ...
    def testOrderCaptureStateDto(self):
        """Test OrderCaptureStateDto"""
