...
class TestSTWSelectedDSDto(unittest.TestCase):
    """STWSelectedDSDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> STWSelectedDSDto:
        """Test STWSelectedDSDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `STWSelectedDSDto`
        """
        model = STWSelectedDSDto()
        if include_optional:
            return STWSelectedDSDto(
