...
class TestExpressPayContextRequest(unittest.TestCase):
    """ExpressPayContextRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExpressPayContextRequest:
        """Test ExpressPayContextRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExpressPayContextRequest`
        """
        model = ExpressPayContextRequest()
        if include_optional:
            return ExpressPayContextRequest(
                timestamp = '',
                payment_context_id = '',
                payment_endpoint = '',
                checkout_id = '',
                redacted_address = order_capture_client.models.redacted_address_request.RedactedAddressRequest(
                    redacted_zip_code = '', 
                    state_code = '', 
                    city = '', ),
                billing_contact = order_capture_client.models.billing_contact_request.BillingContactRequest(
                    checkout_id = '', 
                    id = '', 
                    first_name = 'First', 
                    middle_name = 'First', 
                    ...
                    business_info = order_capture_client.models.business_info.BusinessInfo(
                        ...
                        tax_code = '42356343', 
                        tax_code_type = 'VAT', ), ),
                shipping_contact = order_capture_client.models.shipping_contact_request.ShippingContactRequest(
                    checkout_id = '', 
                    id = '', 
                    first_name = 'First', 
                    middle_name = 'First', 
    ...
    def testExpressPayContextRequest(self):
        """Test ExpressPayContextRequest"""
