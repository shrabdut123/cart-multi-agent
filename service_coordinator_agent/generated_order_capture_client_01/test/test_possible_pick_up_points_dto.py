...
class TestPossiblePickUpPointsDto(unittest.TestCase):
    """PossiblePickUpPointsDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PossiblePickUpPointsDto:
        """Test PossiblePickUpPointsDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PossiblePickUpPointsDto`
        """
        model = PossiblePickUpPointsDto()
        if include_optional:
            return PossiblePickUpPointsDto(
                ...
                pick_up_points = [
                    order_capture_client.models.pick_up_point_dto.PickUpPointDto(
                        ...
                        sto = '468', 
                        metadata = order_capture_client.models.pick_up_point_metadata.PickUpPointMetadata(
                            delivery_service_id = '090aae12-9a55-4080-8920-e3450f6cb881', 
                            delivery_service_solution = 'STANDARD', 
                            delivery_service_fulfillment_method_type = 'HOME_DELIVERY', 
                            delivery_service_fulfillment_possibility = 'PARTIAL', 
    ...
    def testPossiblePickUpPointsDto(self):
        """Test PossiblePickUpPointsDto"""
