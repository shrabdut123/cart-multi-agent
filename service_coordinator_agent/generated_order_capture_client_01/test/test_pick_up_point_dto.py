...
class TestPickUpPointDto(unittest.TestCase):
    """PickUpPointDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PickUpPointDto:
        """Test PickUpPointDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PickUpPointDto`
        """
        model = PickUpPointDto()
        if include_optional:
