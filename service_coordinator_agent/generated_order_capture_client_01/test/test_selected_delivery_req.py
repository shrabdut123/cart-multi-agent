...
class TestSelectedDeliveryReq(unittest.TestCase):
    """SelectedDeliveryReq unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelectedDeliveryReq:
        """Test SelectedDeliveryReq
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SelectedDeliveryReq`
        """
        model = SelectedDeliveryReq()
        if include_optional:
            return SelectedDeliveryReq(
    ...
    def testSelectedDeliveryReq(self):
        """Test SelectedDeliveryReq"""
