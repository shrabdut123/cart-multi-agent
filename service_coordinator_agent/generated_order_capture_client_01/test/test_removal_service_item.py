...
class TestRemovalServiceItem(unittest.TestCase):
    """RemovalServiceItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemovalServiceItem:
        """Test RemovalServiceItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemovalServiceItem`
        """
        model = RemovalServiceItem()
        if include_optional:
            return RemovalServiceItem(
                line_id = '',
                service_item_no = '',
                service_product_id = '',
    ...
    def testRemovalServiceItem(self):
        """Test RemovalServiceItem"""
