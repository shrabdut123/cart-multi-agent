...
class DeltaPriceControllerApi:
    ...
    @validate_call
    def get_delta_prices_for_collect(
        self,
        retail_unit: StrictStr,
        service_area_id: StrictStr,
        checkout_id: StrictStr,
        selected_delivery_service_request: SelectedDeliveryServiceRequest,
        ...
        :param selected_delivery_service_request: (required)
        :type selected_delivery_service_request: SelectedDeliveryServiceRequest
        ...
        _param = self._get_delta_prices_for_collect_serialize(
            retail_unit=retail_unit,
            service_area_id=service_area_id,
            checkout_id=checkout_id,
            selected_delivery_service_request=selected_delivery_service_request,
    ...
    @validate_call
    def get_delta_prices_for_collect_with_http_info(
        self,
        retail_unit: StrictStr,
        service_area_id: StrictStr,
        checkout_id: StrictStr,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeltaPriceResponseDto]:
        """This API helps to calculate the delta prices of the PUP's under targetDelivery(targetDeliveryId would be sent in the request), based on the selected PUP's in previous deliveries
    ...
    @validate_call
    def get_delta_prices_for_collect_without_preload_content(
        self,
        retail_unit: StrictStr,
        service_area_id: StrictStr,
        checkout_id: StrictStr,
    ...
    def _get_delta_prices_for_collect_serialize(
        self,
        retail_unit,
        service_area_id,
        checkout_id,
        selected_delivery_service_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if selected_delivery_service_request is not None:
            _body_params = selected_delivery_service_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{retailUnit}/checkouts/{checkoutId}/service-area/{serviceAreaId}/delta-prices-collect',
    ...
    @validate_call
    def get_delta_prices_for_home_delivery(
        self,
        retail_unit: StrictStr,
        service_area_id: StrictStr,
        checkout_id: StrictStr,
        ...
        _param = self._get_delta_prices_for_home_delivery_serialize(
            retail_unit=retail_unit,
            service_area_id=service_area_id,
            checkout_id=checkout_id,
            selected_delivery_service_request=selected_delivery_service_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DeltaPriceTimeSlotResponseDto",
            '400': "ErrorDetails",
            '404': "ErrorDetails",
            '419': "ErrorDetails",
            '422': "ErrorDetails",
    ...
    @validate_call
    def get_delta_prices_for_home_delivery_with_http_info(
        self,
        retail_unit: StrictStr,
        service_area_id: StrictStr,
        checkout_id: StrictStr,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeltaPriceTimeSlotResponseDto]:
        """This API helps to calculate the delta prices of the Home delivery timeSlots under targetDelivery(targetDeliveryId would be sent in the request), based on the selected Home Delivery's in previous deliveries
    ...
    @validate_call
    def get_delta_prices_for_home_delivery_without_preload_content(
        self,
        retail_unit: StrictStr,
        service_area_id: StrictStr,
        checkout_id: StrictStr,
    ...
    def _get_delta_prices_for_home_delivery_serialize(
        self,
        retail_unit,
        service_area_id,
        checkout_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/{retailUnit}/checkouts/{checkoutId}/service-area/{serviceAreaId}/delta-prices-hd',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
