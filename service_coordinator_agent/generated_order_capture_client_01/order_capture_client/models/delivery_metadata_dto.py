...
class DeliveryMetadataDto(BaseModel):
    """
    ...
    no_stock_delivery: Optional[StrictBool] = Field(default=None, alias="noStockDelivery")
    __properties: ClassVar[List[str]] = ["rangeOfDays", "noStockDelivery"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "noStockDelivery": obj.get("noStockDelivery")
        })
        return _obj
