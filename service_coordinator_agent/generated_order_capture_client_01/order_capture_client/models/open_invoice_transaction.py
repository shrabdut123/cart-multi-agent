...
class OpenInvoiceTransaction(BaseModel):
    """
    ...
    authorization_expiry_date: Optional[StrictStr] = Field(default=None, alias="authorizationExpiryDate")
    __properties: ClassVar[List[str]] = ["amount", "currency", "status", "iopgId", "pspReferenceId", "pspTimestamp", "pspTransactionDateTimeUTC", "pspName", "paymentBrand", "declineReason", "authorizationExpiryDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authorizationExpiryDate": obj.get("authorizationExpiryDate")
        })
        return _obj
