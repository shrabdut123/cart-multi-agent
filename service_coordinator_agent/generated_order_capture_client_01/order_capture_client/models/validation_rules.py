...
class ValidationRules(BaseModel):
    ...
    ValidationRules
    """ # noqa: E501
    is_tax_code_validation_required: Optional[StrictBool] = Field(default=None, alias="isTaxCodeValidationRequired")
    __properties: ClassVar[List[str]] = ["isTaxCodeValidationRequired"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "isTaxCodeValidationRequired": obj.get("isTaxCodeValidationRequired")
        })
        return _obj
