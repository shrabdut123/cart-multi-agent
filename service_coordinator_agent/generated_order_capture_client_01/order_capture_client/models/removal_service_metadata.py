...
class RemovalServiceMetadata(BaseModel):
    """
    RemovalServiceMetadata
    """ # noqa: E501
    reason_of_failure: Optional[StrictStr] = Field(default=None, alias="reasonOfFailure")
    is_service_available: Optional[StrictBool] = Field(default=None, alias="isServiceAvailable")
    __properties: ClassVar[List[str]] = ["reasonOfFailure", "isServiceAvailable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isServiceAvailable": obj.get("isServiceAvailable")
        })
        return _obj
