...
class DeliverySlotMetadataDto(BaseModel):
    """
    ...
    has_price_deviation: Optional[StrictBool] = Field(default=None, description="It is true when there is a price deviation. Else, it will be false. This is relevant only if prime time price is enabled for a market", alias="hasPriceDeviation")
    __properties: ClassVar[List[str]] = ["timeZone", "hasPriceDeviation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hasPriceDeviation": obj.get("hasPriceDeviation")
        })
        return _obj
