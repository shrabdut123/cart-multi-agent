...
class WalletTransaction(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amount", "currency", "status", "iopgId", "pspReferenceId", "pspTimestamp", "pspTransactionDateTimeUTC", "pspName", "authorisationCode", "paymentBrand", "declineReason"]
