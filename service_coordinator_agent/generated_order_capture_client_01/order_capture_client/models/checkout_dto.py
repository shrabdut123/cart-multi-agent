...
class CheckoutDto(BaseModel):
    ...
    items: Optional[List[ItemDto]] = None
    service_items: Optional[List[ServiceItem]] = Field(default=None, alias="serviceItems")
    removal_service_items: Optional[List[RemovalServiceItem]] = Field(default=None, alias="removalServiceItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ItemDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
