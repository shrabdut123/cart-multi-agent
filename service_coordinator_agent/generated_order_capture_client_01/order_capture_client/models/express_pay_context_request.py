...
class ExpressPayContextRequest(BaseModel):
    """
    ...
    redacted_address: Optional[RedactedAddressRequest] = Field(default=None, alias="redactedAddress")
    billing_contact: Optional[BillingContactRequest] = Field(default=None, alias="billingContact")
    shipping_contact: Optional[ShippingContactRequest] = Field(default=None, alias="shippingContact")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "redactedAddress": RedactedAddressRequest.from_dict(obj["redactedAddress"]) if obj.get("redactedAddress") is not None else None,
            "billingContact": BillingContactRequest.from_dict(obj["billingContact"]) if obj.get("billingContact") is not None else None,
            "shippingContact": ShippingContactRequest.from_dict(obj["shippingContact"]) if obj.get("shippingContact") is not None else None
        })
        return _obj
