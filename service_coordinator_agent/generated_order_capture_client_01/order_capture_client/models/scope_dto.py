...
class ScopeDto(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="It describes the super type HOME DELIVERY OR COLLECT")
    sub_types: Optional[List[SubTypeDto]] = Field(default=None, description="It describes the sub types. It is applicable for COLLECT as COLLECt has multiple sub types", alias="subTypes")
    __properties: ClassVar[List[str]] = ["type", "subTypes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "subTypes": [SubTypeDto.from_dict(_item) for _item in obj["subTypes"]] if obj.get("subTypes") is not None else None
        })
        return _obj
