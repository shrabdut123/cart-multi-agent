...
class BusinessCreditTransaction(BaseModel):
    """
    ...
    authorisation_code: Optional[StrictStr] = Field(default=None, alias="authorisationCode")
    ...
    account_number_source: Optional[StrictStr] = Field(default=None, alias="accountNumberSource")
    __properties: ClassVar[List[str]] = ["amount", "purchaseOrderNumber", "currency", "status", "iopgId", "pspReferenceId", "authorisationCode", "pspTimestamp", "pspTransactionDateTimeUTC", "pspName", "paymentBrand", "paymentCardDetails", "declineReason", "accountNumber", "accountNumberSource"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authorisationCode": obj.get("authorisationCode"),
            ...
            "accountNumberSource": obj.get("accountNumberSource")
        })
        return _obj
