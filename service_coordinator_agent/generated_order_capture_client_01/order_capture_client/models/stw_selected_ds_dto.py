...
class STWSelectedDSDto(BaseModel):
    """
    ...
    """ # noqa: E501
    solution_id: Optional[StrictStr] = Field(default=None, description="It describes the selected delivery service", alias="solutionId")
    deliveries: Optional[List[STWDeliveryDto]] = Field(default=None, description="The deliveries and time windows of a selected service")
    __properties: ClassVar[List[str]] = ["solutionId", "deliveries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deliveries": [STWDeliveryDto.from_dict(_item) for _item in obj["deliveries"]] if obj.get("deliveries") is not None else None
        })
        return _obj
