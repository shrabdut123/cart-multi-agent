...
class DeliveryAreaRequest(BaseModel):
    ...
    enable_range_of_days: Optional[StrictBool] = Field(default=None, alias="enableRangeOfDays")
    __properties: ClassVar[List[str]] = ["id", "zipCode", "stateCode", "city", "enableRangeOfDays"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "city": obj.get("city"),
            "enableRangeOfDays": obj.get("enableRangeOfDays")
        })
        return _obj
