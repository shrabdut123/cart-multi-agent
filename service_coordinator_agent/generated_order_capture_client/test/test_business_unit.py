...
class TestBusinessUnit(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BusinessUnit:
        """Test BusinessUnit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessUnit`
        """
        model = BusinessUnit()
        if include_optional:
            return BusinessUnit(
