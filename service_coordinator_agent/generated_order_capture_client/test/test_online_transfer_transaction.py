...
class TestOnlineTransferTransaction(unittest.TestCase):
    """OnlineTransferTransaction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OnlineTransferTransaction:
        """Test OnlineTransferTransaction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OnlineTransferTransaction`
        """
        model = OnlineTransferTransaction()
        if include_optional:
            return OnlineTransferTransaction(
                amount = 45.67,
                currency = 'SEK',
                status = 'CAPTURED ',
                iopg_id = 'EU123456789',
    ...
    def testOnlineTransferTransaction(self):
        """Test OnlineTransferTransaction"""
