...
class TestPossibleServiceTimeWindowDto(unittest.TestCase):
    """PossibleServiceTimeWindowDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PossibleServiceTimeWindowDto:
        """Test PossibleServiceTimeWindowDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PossibleServiceTimeWindowDto`
        """
        model = PossibleServiceTimeWindowDto()
        if include_optional:
            return PossibleServiceTimeWindowDto(
    ...
    def testPossibleServiceTimeWindowDto(self):
        """Test PossibleServiceTimeWindowDto"""
