...
class TestPossibleServiceTimeWindowsDto(unittest.TestCase):
    """PossibleServiceTimeWindowsDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PossibleServiceTimeWindowsDto:
        """Test PossibleServiceTimeWindowsDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PossibleServiceTimeWindowsDto`
        """
        model = PossibleServiceTimeWindowsDto()
        if include_optional:
            return PossibleServiceTimeWindowsDto(
    ...
    def testPossibleServiceTimeWindowsDto(self):
        """Test PossibleServiceTimeWindowsDto"""
