...
class TestDeliveryAndServiceEntity(unittest.TestCase):
    """DeliveryAndServiceEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeliveryAndServiceEntity:
        """Test DeliveryAndServiceEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeliveryAndServiceEntity`
        """
        model = DeliveryAndServiceEntity()
        if include_optional:
            return DeliveryAndServiceEntity(
    ...
    def testDeliveryAndServiceEntity(self):
        """Test DeliveryAndServiceEntity"""
