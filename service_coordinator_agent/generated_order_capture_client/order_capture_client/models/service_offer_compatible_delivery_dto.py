...
class ServiceOfferCompatibleDeliveryDto(BaseModel):
    """
    It describes if the delivery service is compatible with service offer
    """ # noqa: E501
    delivery_service_item_no: Optional[StrictStr] = Field(default=None, alias="deliveryServiceItemNo")
    __properties: ClassVar[List[str]] = ["deliveryServiceItemNo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deliveryServiceItemNo": obj.get("deliveryServiceItemNo")
        })
        return _obj
