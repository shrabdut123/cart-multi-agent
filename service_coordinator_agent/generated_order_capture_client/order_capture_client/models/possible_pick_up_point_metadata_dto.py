...
class PossiblePickUpPointMetadataDto(BaseModel):
    """
    It describes informational metadata i.e. closestPickUpPointId as an example
    """ # noqa: E501
    closest_pick_up_point_id: Optional[StrictStr] = Field(default=None, description="It is the order capture generated PUP identifier of a closest pick up point", alias="closestPickUpPointId")
    __properties: ClassVar[List[str]] = ["closestPickUpPointId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "closestPickUpPointId": obj.get("closestPickUpPointId")
        })
        return _obj
