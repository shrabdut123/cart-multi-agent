...
class ServiceOffer(BaseModel):
    ...
    inactive_reason: Optional[StrictStr] = Field(default=None, alias="inactiveReason")
    service_product_id: Optional[StrictStr] = Field(default=None, alias="serviceProductId")
    service_item_number: Optional[StrictStr] = Field(default=None, alias="serviceItemNumber")
    market_csc_enabled: Optional[StrictBool] = Field(default=None, alias="marketCSCEnabled")
    provider: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["active", "servicePrice", "inactiveReason", "serviceProductId", "serviceItemNumber", "marketCSCEnabled", "provider"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inactiveReason": obj.get("inactiveReason"),
            "serviceProductId": obj.get("serviceProductId"),
            "serviceItemNumber": obj.get("serviceItemNumber"),
            "marketCSCEnabled": obj.get("marketCSCEnabled"),
