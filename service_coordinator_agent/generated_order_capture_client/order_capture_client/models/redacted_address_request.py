...
class RedactedAddressRequest(BaseModel):
    """
    RedactedAddressRequest
    """ # noqa: E501
    redacted_zip_code: StrictStr = Field(alias="redactedZipCode")
    state_code: Optional[StrictStr] = Field(default=None, alias="stateCode")
    city: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["redactedZipCode", "stateCode", "city"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "redactedZipCode": obj.get("redactedZipCode"),
