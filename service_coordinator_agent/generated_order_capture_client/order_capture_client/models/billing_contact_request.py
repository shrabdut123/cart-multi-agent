...
class BillingContactRequest(BaseModel):
    ...
    alternate_collector_first_name: Optional[StrictStr] = Field(default=None, alias="alternateCollectorFirstName")
    alternate_collector_sur_name: Optional[StrictStr] = Field(default=None, alias="alternateCollectorSurName")
    same_as_shipping_contact: Optional[StrictBool] = Field(default=None, alias="sameAsShippingContact")
    ...
    business_info: Optional[BusinessInfo] = Field(default=None, alias="businessInfo")
    __properties: ClassVar[List[str]] = ["checkoutId", "id", "firstName", "middleName", "lastName", "secondSurname", "phoneticFirstName", "phoneticLastName", "city", "state", "country", "county", "addressLine1", "addressLine2", "addressLine3", "landLineNumber", "faxNumber", "stateCode", "fiscalCode", "taxCode", "taxCodeType", "recipientCodeType", "recipientCode", "countryOfOrigin", "email", "alternateCollectorFirstName", "alternateCollectorSurName", "sameAsShippingContact", "mobileNumber", "zipCode", "businessInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "alternateCollectorFirstName": obj.get("alternateCollectorFirstName"),
            "alternateCollectorSurName": obj.get("alternateCollectorSurName"),
            "sameAsShippingContact": obj.get("sameAsShippingContact"),
            "mobileNumber": obj.get("mobileNumber"),
            "zipCode": obj.get("zipCode"),
            "businessInfo": BusinessInfo.from_dict(obj["businessInfo"]) if obj.get("businessInfo") is not None else None
        })
        return _obj
