...
class DeliverySlot(BaseModel):
    ...
    DeliverySlot
    """ # noqa: E501
    metadata: Optional[DeliverySlotMetadata] = None
    ...
    tsp_id: Optional[StrictStr] = Field(default=None, alias="tspId")
    tsp_name: Optional[StrictStr] = Field(default=None, alias="tspName")
    slot_attribute_group: Optional[StrictStr] = Field(default=None, alias="slotAttributeGroup")
    capability: Optional[List[DeliverySlotCapability]] = None
    price: Optional[SlotPrice] = None
    __properties: ClassVar[List[str]] = ["metadata", "id", "fromDateTime", "toDateTime", "node", "resourcePoolId", "tspId", "tspName", "slotAttributeGroup", "capability", "price"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": DeliverySlotMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "id": obj.get("id"),
            ...
            "tspId": obj.get("tspId"),
            "tspName": obj.get("tspName"),
            "slotAttributeGroup": obj.get("slotAttributeGroup"),
            "capability": [DeliverySlotCapability.from_dict(_item) for _item in obj["capability"]] if obj.get("capability") is not None else None,
