...
class PrepaidCardTransaction(BaseModel):
    """
    ...
    balance_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="balanceAmount")
    ...
    __properties: ClassVar[List[str]] = ["amount", "balanceAmount", "currency", "balanceCurrency", "status", "iopgId", "pspReferenceId", "pspTimestamp", "pspTransactionDateTimeUTC", "pspName", "paymentBrand", "paymentCardDetails"]
