...
class ServiceQuestionRelation(BaseModel):
    """
    ...
    """ # noqa: E501
    service_method: Optional[StrictStr] = Field(default=None, description="It refers to a method of delivery i.e. TRUCK or PARCEL", alias="serviceMethod")
    question_references: Optional[List[StrictStr]] = Field(default=None, description="It refers to the list of question references for the associated serviceId", alias="questionReferences")
    __properties: ClassVar[List[str]] = ["serviceMethod", "questionReferences"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "questionReferences": obj.get("questionReferences")
        })
        return _obj
