...
class QuestionsAndAnswers(BaseModel):
    ...
    QuestionsAndAnswers
    """ # noqa: E501
    checkout_id: StrictStr = Field(alias="checkoutId")
    user_id: StrictStr = Field(alias="userId")
    questions_and_answers: Optional[Questions] = Field(default=None, alias="questionsAndAnswers")
    __properties: ClassVar[List[str]] = ["checkoutId", "userId", "questionsAndAnswers"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.questions_and_answers:
            _dict['questionsAndAnswers'] = self.questions_and_answers.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "questionsAndAnswers": Questions.from_dict(obj["questionsAndAnswers"]) if obj.get("questionsAndAnswers") is not None else None
        })
        return _obj
