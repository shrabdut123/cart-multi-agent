...
class ItemReference(BaseModel):
    ...
    ItemReference
    """ # noqa: E501
    item_line_id: Optional[StrictStr] = Field(default=None, alias="itemLineId")
    item_no: Optional[StrictStr] = Field(default=None, alias="itemNo")
    quantity: Optional[StrictStr] = None
    is_co_worker_assistance_needed: Optional[StrictBool] = Field(default=None, alias="isCoWorkerAssistanceNeeded")
    __properties: ClassVar[List[str]] = ["itemLineId", "itemNo", "quantity", "isCoWorkerAssistanceNeeded"]
