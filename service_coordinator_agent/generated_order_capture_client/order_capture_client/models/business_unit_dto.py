...
class BusinessUnitDto(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="It describes the business unit code. At times it is retail unit itself i.e. SE or at times it is a code 010 and it depends on type")
    type: Optional[StrictStr] = Field(default=None, description="It describes the type of business unit STO or RU")
