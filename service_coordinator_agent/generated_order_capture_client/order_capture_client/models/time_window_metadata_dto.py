...
class TimeWindowMetadataDto(BaseModel):
    """
    It describes time window metadata and this is an informational attribute
    """ # noqa: E501
    available: Optional[StrictBool] = Field(default=None, description="This describes if the time window capacity is available. This is an informational attribute")
