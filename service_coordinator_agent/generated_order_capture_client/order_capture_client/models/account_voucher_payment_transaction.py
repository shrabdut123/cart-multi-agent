...
class AccountVoucherPaymentTransaction(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["amount", "currency", "status", "iopgId", "pspReferenceId", "pspTimestamp", "pspTransactionDateTimeUTC", "pspName", "paymentBrand", "reference", "expiryDate", "entityId"]
