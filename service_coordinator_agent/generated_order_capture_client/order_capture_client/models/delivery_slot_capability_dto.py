...
class DeliverySlotCapabilityDto(BaseModel):
    """
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="It describes the capability for a slot. An example is whether this slot is available for contactless delivery i.e. Authority to leave goods")
