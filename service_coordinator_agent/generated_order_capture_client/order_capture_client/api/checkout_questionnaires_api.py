...
class CheckoutQuestionnairesApi:
    ...
    def get_questionnaires(
        ...
        _param = self._get_questionnaires_serialize(
    ...
    @validate_call
    def get_questionnaires_with_http_info(
        self,
        retail_unit: StrictStr,
        checkout_id: StrictStr,
        service_area_id: StrictStr,
    ...
    @validate_call
    def get_questionnaires_without_preload_content(
        self,
        retail_unit: StrictStr,
        checkout_id: StrictStr,
        service_area_id: StrictStr,
    ...
    def _get_questionnaires_serialize(
        self,
        retail_unit,
        checkout_id,
        service_area_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/{retailUnit}/checkouts/{checkoutId}/service-area/{serviceAreaId}/selected-delivery-and-services/questionnaires',
    ...
    @validate_call
    def patch_questionnaire_answers(
        self,
        retail_unit: StrictStr,
        checkout_id: StrictStr,
        service_area_id: StrictStr,
        ...
        _param = self._patch_questionnaire_answers_serialize(
            retail_unit=retail_unit,
            checkout_id=checkout_id,
            service_area_id=service_area_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def patch_questionnaire_answers_with_http_info(
        self,
        retail_unit: StrictStr,
        checkout_id: StrictStr,
        service_area_id: StrictStr,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QuestionsAndAnswers]:
        """Service to save the answered delivery & service questions
    ...
    @validate_call
    def patch_questionnaire_answers_without_preload_content(
        self,
        retail_unit: StrictStr,
        checkout_id: StrictStr,
        service_area_id: StrictStr,
    ...
    def _patch_questionnaire_answers_serialize(
        self,
        retail_unit,
        checkout_id,
        service_area_id,
