...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**fetch_service_prices**](docs/DefaultApi.md#fetch_service_prices) | **POST** /graphql | GraphQL endpoint


## Documentation For Models

 - [FetchServicePricesRequest](docs/FetchServicePricesRequest.md)
