...
class ClassFilter(BaseModel):
    ...
    values: Optional[List[ClassFilterValue]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "values": [ClassFilterValue.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
