...
class CatalogueReference(BaseModel):
    ...
    CatalogueReference
    """ # noqa: E501
    catalogue_id: Optional[StrictStr] = Field(default=None, alias="catalogueId")
    category_id: Optional[StrictStr] = Field(default=None, alias="categoryId")
    __properties: ClassVar[List[str]] = ["catalogueId", "categoryId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "catalogueId": obj.get("catalogueId"),
