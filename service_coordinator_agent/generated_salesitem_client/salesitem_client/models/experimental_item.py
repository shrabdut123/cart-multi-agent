...
class ExperimentalItem(BaseModel):
    """
    ExperimentalItem
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the experiment, e.g. \"teamname-testname\"")
    data: Optional[StrictStr] = Field(default=None, description="JSON-encoded data for the feature")
