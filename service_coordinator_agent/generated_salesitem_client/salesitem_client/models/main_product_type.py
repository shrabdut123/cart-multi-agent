...
class MainProductType(BaseModel):
    """
    MainProductType
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the Main Product Type (`MPT`), e.g., `SPR table + chair` or `wardrobes`. This field is always in English.")
    var_false: Optional[StrictStr] = Field(default=None, description="The unique identifier for the Main Product Type (`MPT`), e.g., `00038` and `00076`.", alias="false")
    __properties: ClassVar[List[str]] = ["name", "false"]
