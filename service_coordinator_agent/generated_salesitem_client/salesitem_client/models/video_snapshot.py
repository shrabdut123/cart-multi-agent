...
class VideoSnapshot(BaseModel):
    ...
    frame: Optional[StrictInt] = Field(default=None, description="The frame, in seconds, that this image represents in the video.")
    height: Optional[StrictInt] = None
    href: Optional[StrictStr] = None
    width: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["fileMimeType", "fileName", "frame", "height", "href", "width"]
