...
class LocaleProductTagValue(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['RETURN_POLICY_URL', 'NUMBER_OF_DAYS']):
            raise ValueError("must be one of enum values ('RETURN_POLICY_URL', 'NUMBER_OF_DAYS')")
        return value
