...
class UnitInformation(BaseModel):
    ...
    unit_imperial_value: Optional[StrictStr] = Field(default=None, alias="unitImperialValue")
    unit_metric: Optional[StrictStr] = Field(default=None, alias="unitMetric")
    unit_metric_value: Optional[StrictStr] = Field(default=None, alias="unitMetricValue")
    __properties: ClassVar[List[str]] = ["unitImperial", "unitImperialValue", "unitMetric", "unitMetricValue"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unitImperialValue": obj.get("unitImperialValue"),
            "unitMetric": obj.get("unitMetric"),
            "unitMetricValue": obj.get("unitMetricValue")
        })
        return _obj
