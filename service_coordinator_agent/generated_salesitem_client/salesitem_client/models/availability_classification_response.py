...
class AvailabilityClassificationResponse(BaseModel):
    """
    AvailabilityClassificationResponse
    """ # noqa: E501
    data: Optional[List[ItemAvailabilityClassification]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ItemAvailabilityClassification.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
