...
class CareInstructionText(BaseModel):
    """
    CareInstructionText
    """ # noqa: E501
    care_instruction_text: Optional[StrictStr] = Field(default=None, alias="careInstructionText")
    __properties: ClassVar[List[str]] = ["careInstructionText"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "careInstructionText": obj.get("careInstructionText")
        })
        return _obj
