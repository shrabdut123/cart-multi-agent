...
class FullLengthText(BaseModel):
    """
    FullLengthText
    """ # noqa: E501
    subject_id: Optional[StrictStr] = Field(default=None, alias="subjectId")
    texts: Optional[List[FullLengthTextDetailed]] = None
    __properties: ClassVar[List[str]] = ["subjectId", "texts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "texts": [FullLengthTextDetailed.from_dict(_item) for _item in obj["texts"]] if obj.get("texts") is not None else None
        })
        return _obj
