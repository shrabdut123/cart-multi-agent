...
class CertificationMedia(BaseModel):
    ...
    CertificationMedia
    """ # noqa: E501
    alt_text: Optional[StrictStr] = Field(default=None, description="Alternate text for image", alias="altText")
    display_text: Optional[StrictStr] = Field(default=None, description="Text to be displayed instead of image when space is limited", alias="displayText")
    media_info_url: Optional[StrictStr] = Field(default=None, description="Link to test institutes website for additional information", alias="mediaInfoURL")
    type: Optional[StrictStr] = None
    variants: Optional[List[MediaVariant]] = None
    __properties: ClassVar[List[str]] = ["altText", "displayText", "mediaInfoURL", "type", "variants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mediaInfoURL": obj.get("mediaInfoURL"),
            "type": obj.get("type"),
