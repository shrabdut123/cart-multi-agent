...
class ItemPartMaterial(BaseModel):
    """
    ItemPartMaterial
    """ # noqa: E501
    material_text: Optional[StrictStr] = Field(default=None, alias="materialText")
    part_text: Optional[StrictStr] = Field(default=None, alias="partText")
    __properties: ClassVar[List[str]] = ["materialText", "partText"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "materialText": obj.get("materialText"),
            "partText": obj.get("partText")
        })
        return _obj
