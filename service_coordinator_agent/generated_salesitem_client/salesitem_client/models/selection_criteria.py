...
class SelectionCriteria(BaseModel):
    ...
    type_name_global: Optional[StrictStr] = Field(default=None, alias="typeNameGlobal")
    type_no: Optional[StrictStr] = Field(default=None, alias="typeNo")
    values: Optional[List[SelectionCriteriaValue]] = None
    __properties: ClassVar[List[str]] = ["typeName", "typeNameGlobal", "typeNo", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "typeNameGlobal": obj.get("typeNameGlobal"),
            "typeNo": obj.get("typeNo"),
            "values": [SelectionCriteriaValue.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
