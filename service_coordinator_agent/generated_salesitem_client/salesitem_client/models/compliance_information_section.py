...
class ComplianceInformationSection(BaseModel):
    """
    ComplianceInformationSection
    """ # noqa: E501
    heading: Optional[StrictStr] = None
    urls: Optional[List[ComplianceUrl]] = None
    values: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["heading", "urls", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "urls": [ComplianceUrl.from_dict(_item) for _item in obj["urls"]] if obj.get("urls") is not None else None,
