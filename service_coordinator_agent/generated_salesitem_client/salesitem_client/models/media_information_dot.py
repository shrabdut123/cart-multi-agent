...
class MediaInformationDot(BaseModel):
    """
    ...
    """ # noqa: E501
    coordinates: Optional[MediaInformationDotCoordinates] = None
    header: Optional[StrictStr] = None
    icon: Optional[StrictStr] = None
    text: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["coordinates", "header", "icon", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "coordinates": MediaInformationDotCoordinates.from_dict(obj["coordinates"]) if obj.get("coordinates") is not None else None,
