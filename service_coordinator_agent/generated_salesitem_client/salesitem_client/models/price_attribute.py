...
class PriceAttribute(BaseModel):
    ...
    PriceAttribute
    """ # noqa: E501
    type: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="Type of additional attribute.")
    value: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="Value of the additional attribute")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['MaximumRetailPrice', 'FreeOfFreight']):
            raise ValueError("must be one of enum values ('MaximumRetailPrice', 'FreeOfFreight')")
        return value
