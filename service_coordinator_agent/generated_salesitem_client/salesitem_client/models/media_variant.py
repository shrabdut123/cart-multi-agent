...
class MediaVariant(BaseModel):
    ...
    href: Optional[StrictStr] = Field(default=None, description="An SEO friendly URL having the format `https://www.ikea.com/{countryCode}/{languageCode}/images/products/{productName}-{productType}-{validDesignText}__{fileName}.JPG`. If `productName` and/or `productType` don't exist, then the original URL is returned. If `validDesignText` doesn't exist, then it is simply omitted from the URL.")
    quality: Optional[StrictStr] = None
    width: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["fileMimeType", "fileName", "height", "href", "quality", "width"]
