...
class News(BaseModel):
    ...
    value: Optional[StrictBool] = Field(default=None, description="Is the item considered news according to RPIM API")
    __properties: ClassVar[List[str]] = ["validFrom", "validTo", "value"]
