...
class AdvertisementLocalisedCommunications(BaseModel):
    """
    AdvertisementLocalisedCommunications
    """ # noqa: E501
    country_code: Optional[StrictStr] = Field(default=None, alias="countryCode")
    full: Optional[StrictStr] = Field(default=None, description="Full advertisement text")
    language_code: Optional[StrictStr] = Field(default=None, alias="languageCode")
    short: Optional[StrictStr] = Field(default=None, description="Short advertisement text")
    __properties: ClassVar[List[str]] = ["countryCode", "full", "languageCode", "short"]
