...
class Warning(BaseModel):
    ...
    Warning
    """ # noqa: E501
    texts: Optional[List[WarningText]] = None
    type: StrictStr
    __properties: ClassVar[List[str]] = ["texts", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CHOKING_HAZARD', 'PROPOSITION_65', 'TIP_OVER_HAZARD']):
            raise ValueError("must be one of enum values ('CHOKING_HAZARD', 'PROPOSITION_65', 'TIP_OVER_HAZARD')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "texts": [WarningText.from_dict(_item) for _item in obj["texts"]] if obj.get("texts") is not None else None,
            "type": obj.get("type")
        })
        return _obj
