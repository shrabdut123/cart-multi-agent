...
class WarningText(BaseModel):
    ...
    """ # noqa: E501
    text: StrictStr
    urls: Optional[List[WarningUrl]] = None
    __properties: ClassVar[List[str]] = ["text", "urls"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "urls": [WarningUrl.from_dict(_item) for _item in obj["urls"]] if obj.get("urls") is not None else None
        })
        return _obj
