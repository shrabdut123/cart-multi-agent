...
class TestSalesPricePreviousSalesPrice(unittest.TestCase):
    """SalesPricePreviousSalesPrice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesPricePreviousSalesPrice:
        """Test SalesPricePreviousSalesPrice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesPricePreviousSalesPrice`
        """
        model = SalesPricePreviousSalesPrice()
        if include_optional:
            return SalesPricePreviousSalesPrice(
                display = True,
    ...
    def testSalesPricePreviousSalesPrice(self):
        """Test SalesPricePreviousSalesPrice"""
