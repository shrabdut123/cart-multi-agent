...
class TestProfessionalAssemblyTime(unittest.TestCase):
    """ProfessionalAssemblyTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfessionalAssemblyTime:
        """Test ProfessionalAssemblyTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfessionalAssemblyTime`
        """
        model = ProfessionalAssemblyTime()
        if include_optional:
            return ProfessionalAssemblyTime(
                unit = 'MINUTES',
                value = 120
            )
        else:
    ...
    def testProfessionalAssemblyTime(self):
        """Test ProfessionalAssemblyTime"""
