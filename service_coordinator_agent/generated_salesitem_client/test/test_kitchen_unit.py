...
class TestKitchenUnit(unittest.TestCase):
    """KitchenUnit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KitchenUnit:
        """Test KitchenUnit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KitchenUnit`
        """
        model = KitchenUnit()
        if include_optional:
            return KitchenUnit(
