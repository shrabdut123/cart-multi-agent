...
class TestItemPartMaterial(unittest.TestCase):
    """ItemPartMaterial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemPartMaterial:
        """Test ItemPartMaterial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemPartMaterial`
        """
        model = ItemPartMaterial()
        if include_optional:
            return ItemPartMaterial(
