...
class TestSalesPriceResponse(unittest.TestCase):
    """SalesPriceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalesPriceResponse:
        """Test SalesPriceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalesPriceResponse`
        """
        model = SalesPriceResponse()
        if include_optional:
            return SalesPriceResponse(
                data = [
                    salesitem_client.models.item_sales_price.itemSalesPrice(
                        advertisements = [
    ...
    def testSalesPriceResponse(self):
        """Test SalesPriceResponse"""
