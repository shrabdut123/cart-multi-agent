...
class TestItemGoodToKnow(unittest.TestCase):
    """ItemGoodToKnow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemGoodToKnow:
        """Test ItemGoodToKnow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemGoodToKnow`
        """
        model = ItemGoodToKnow()
        if include_optional:
            return ItemGoodToKnow(
