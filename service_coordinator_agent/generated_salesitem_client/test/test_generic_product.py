...
class TestGenericProduct(unittest.TestCase):
    """GenericProduct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenericProduct:
        """Test GenericProduct
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenericProduct`
        """
