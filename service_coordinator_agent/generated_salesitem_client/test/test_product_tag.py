...
class TestProductTag(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProductTag:
        """Test ProductTag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductTag`
        """
        model = ProductTag()
        if include_optional:
            return ProductTag(
