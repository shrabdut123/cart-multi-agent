...
class TestClassFilter(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ClassFilter:
        """Test ClassFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClassFilter`
        """
        model = ClassFilter()
        if include_optional:
            return ClassFilter(
