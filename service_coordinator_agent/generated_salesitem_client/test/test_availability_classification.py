...
class TestAvailabilityClassification(unittest.TestCase):
    """AvailabilityClassification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvailabilityClassification:
        """Test AvailabilityClassification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvailabilityClassification`
        """
        model = AvailabilityClassification()
        if include_optional:
    ...
    def testAvailabilityClassification(self):
        """Test AvailabilityClassification"""
