...
class TestExperimentalItem(unittest.TestCase):
    """ExperimentalItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExperimentalItem:
        """Test ExperimentalItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExperimentalItem`
        """
        model = ExperimentalItem()
        if include_optional:
