...
class TestPriceAttribute(unittest.TestCase):
    """PriceAttribute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriceAttribute:
        """Test PriceAttribute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriceAttribute`
        """
