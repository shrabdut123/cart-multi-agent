...
class TestUpsellArgument(unittest.TestCase):
    """UpsellArgument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsellArgument:
        """Test UpsellArgument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsellArgument`
        """
        model = UpsellArgument()
        if include_optional:
            return UpsellArgument(
