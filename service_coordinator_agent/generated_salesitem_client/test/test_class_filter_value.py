...
class TestClassFilterValue(unittest.TestCase):
    """ClassFilterValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClassFilterValue:
        """Test ClassFilterValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClassFilterValue`
        """
        model = ClassFilterValue()
        if include_optional:
