...
class TestLocaleProductTagValue(unittest.TestCase):
    """LocaleProductTagValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocaleProductTagValue:
        """Test LocaleProductTagValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocaleProductTagValue`
        """
        model = LocaleProductTagValue()
        if include_optional:
            return LocaleProductTagValue(
    ...
    def testLocaleProductTagValue(self):
        """Test LocaleProductTagValue"""
