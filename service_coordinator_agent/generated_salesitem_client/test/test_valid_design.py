...
class TestValidDesign(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ValidDesign:
        """Test ValidDesign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidDesign`
        """
        model = ValidDesign()
        if include_optional:
            return ValidDesign(
