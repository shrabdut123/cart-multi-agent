...
class TestCareInstructionText(unittest.TestCase):
    """CareInstructionText unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CareInstructionText:
        """Test CareInstructionText
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CareInstructionText`
        """
        model = CareInstructionText()
        if include_optional:
            return CareInstructionText(
    ...
    def testCareInstructionText(self):
        """Test CareInstructionText"""
