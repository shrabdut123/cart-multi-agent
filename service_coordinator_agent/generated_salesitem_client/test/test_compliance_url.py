...
class TestComplianceUrl(unittest.TestCase):
    """ComplianceUrl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ComplianceUrl:
        """Test ComplianceUrl
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ComplianceUrl`
        """
        model = ComplianceUrl()
        if include_optional:
