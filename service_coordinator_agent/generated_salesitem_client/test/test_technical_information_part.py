...
class TestTechnicalInformationPart(unittest.TestCase):
    """TechnicalInformationPart unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TechnicalInformationPart:
        """Test TechnicalInformationPart
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TechnicalInformationPart`
        """
        model = TechnicalInformationPart()
        if include_optional:
            return TechnicalInformationPart(
                explanatory_text = '',
                legal = True,
                range_no = '00004',
    ...
    def testTechnicalInformationPart(self):
        """Test TechnicalInformationPart"""
