...
class TestSelectionCriteria(unittest.TestCase):
    """SelectionCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SelectionCriteria:
        """Test SelectionCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SelectionCriteria`
        """
    ...
    def testSelectionCriteria(self):
        """Test SelectionCriteria"""
