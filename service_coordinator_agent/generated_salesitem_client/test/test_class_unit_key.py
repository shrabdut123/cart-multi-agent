...
class TestClassUnitKey(unittest.TestCase):
    """ClassUnitKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClassUnitKey:
        """Test ClassUnitKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClassUnitKey`
        """
        model = ClassUnitKey()
        if include_optional:
            return ClassUnitKey(
