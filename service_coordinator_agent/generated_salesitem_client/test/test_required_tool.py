...
class TestRequiredTool(unittest.TestCase):
    """RequiredTool unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequiredTool:
        """Test RequiredTool
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequiredTool`
        """
        model = RequiredTool()
        if include_optional:
            return RequiredTool(
