...
class ForecastGet200ResponseCurrentWeatherUnits(BaseModel):
    """
    ...
    windspeed: Optional[StrictStr] = None
    winddirection: Optional[StrictStr] = None
    is_day: Optional[StrictStr] = None
    weathercode: Optional[StrictStr] = None
