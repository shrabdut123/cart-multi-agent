...
class ForecastGet200ResponseCurrentWeather(BaseModel):
    """
    ...
    windspeed: Optional[Union[StrictFloat, StrictInt]] = None
    winddirection: Optional[StrictInt] = None
    is_day: Optional[StrictInt] = None
    weathercode: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["time", "interval", "temperature", "windspeed", "winddirection", "is_day", "weathercode"]
