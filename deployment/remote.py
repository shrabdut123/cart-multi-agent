...
def create() -> None:
    ...
    remote_app = agent_engines.create(
        ...
        extra_packages=["./service_coordinator_agent"],
        display_name="Service Coordinator Agent",
        description="An agent that coordinates services for IKEA customers.",
    )
...
def list_sessions(resource_id: str, user_id: str) -> None:
    ...
    for session in sessions["sessions"]:
        ...
        print(f"  Last Updated: {session['lastUpdateTime']}")
